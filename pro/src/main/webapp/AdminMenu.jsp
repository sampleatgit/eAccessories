...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<a class="navbar-brand" href="#">eAccessories</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link"
				...
				<li class="nav-item"><a class="nav-link"
				href="ListProductController">List Product</a></li>
			<li class="nav-item"><a class="nav-link"
				href="AddProduct.jsp">Add Product</a></li>
		<!-- 	<li class="nav-item dropdown"><a
				class="nav-link dropdown-toggle" href="ListProductController" id="navbarDropdown"
				role="button" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false"> List Product </a>
